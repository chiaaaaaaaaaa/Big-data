...
y = `Percentage change of votes to the center`, 
fill = `Percentage change of votes to the center` ))+
    geom_bar(stat = "identity")+
...
y = `Average change in orientation index`,
fill =  `Average change in orientation index`)) +
  geom_bar(stat = "identity") +
  coord_flip() +
  scale_y_continuous(labels = label_percent(scale = 1)) +
...
| center_perc_points
  _change | numerical, continuous | change (in percentage points) in the proportion of the population voting to the center |
