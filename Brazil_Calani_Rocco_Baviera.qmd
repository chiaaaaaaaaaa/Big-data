...
left_colors <- ifelse(
  ...
  ifelse(formatted_table_wide$left_diff > 5 & formatted_table_wide$left_diff <= 20,
...
center_colors <- ifelse(
  ...
  ifelse(formatted_table_wide$center_diff > 5 & formatted_table_wide$center_diff <= 20,
"#D9F2D1",
...
right_colors <- ifelse(
  ...
  ifelse(formatted_table_wide$right_diff > 5 & formatted_table_wide$right_diff <= 20,
"#D9F2D1",
